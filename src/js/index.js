...
personagens.forEach((personagem) => {
    personagem.addEventListener('mouseenter', () => {
        ...
        if(idSelecionado === 'edyrthalion') return;
        
        // pra não deixar disponível pro jogador 1 escolher o ultron, visto que esse já foi escolhido pelo jogador 2
...
// o id e a imagem precisam ter o mesmo nome